...
class MissionPanel(QtWidgets.QWidget):
    ...
    # ========== 固定配置（修改这里即可全局同步） ==========
    DEFAULT_COLUMNS = ['任务编号', '任务名称', '状态', '1', '2', '3', '4', '5', '6', '7', '8', '曲线']
    DEFAULT_WIDTHS = [80, 140, 70, 30, 30, 30, 30, 30, 30, 30, 30, 50]
    CURVE_BUTTON_COLUMN = 11  # 曲线按钮所在列（使用动态曲线图标）
    CHANNEL_START_COLUMN = 3  # 通道列开始索引
    CHANNEL_COUNT = 8  # 通道数量
    # ====================================================

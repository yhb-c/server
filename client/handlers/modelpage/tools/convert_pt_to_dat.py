...
def main():
    parser = argparse.ArgumentParser(description="将.pt文件转换为.dat文件")
    parser.add_argument("--input", "-i", type=str, default="D:/Liquid_Level_detect_yolov11/ultralytics/runs/train/exp_mix6",
                       help="输入目录路径")

...
//智能设备类型
    ...
    public static final int NET_SDK_LOCAL_CFG_TYPE_CHECK_DEV = 10; //心跳交互间隔时间配置
    /**********************设备类型 end***********************/
...
//入侵参数
    ...
    */
    ...
    public static class NET_DVR_ALARM_SEARCH_COND extends Structure {
        public int dwSize;
        public NET_DVR_TIME_SEARCH_COND strStartTime = new NET_DVR_TIME_SEARCH_COND(); //开始时间,时间为空则代表不通过时间筛选。
        public NET_DVR_TIME_SEARCH_COND strStopTime = new NET_DVR_TIME_SEARCH_COND();  //结束时间, 时间为空则代表不通过时间筛选。
        /*
	 ...
	 */
        ...
        public short wEventType;//事件类型，仅dwAlarmComm为COMM_VCA_ALARM 	0x4993  智能检测报警有效，0-表示所有事件,1-混合目标检测（mixedTargetDetection）,2-雷视目标检测（radarVideoDetection）
        public short wSubEventType;//子事件类型，0-表示所有子事件，其余值根据wEventType的取值变化而变化，具体参见能力集。
        public byte bySupport; //保留
        public byte byNoBoundary; //是否不带boundary，0-否，1-是，仅dwAlarmComm为智能检测报警时有效
    ...
    //设备在线巡检参数结构体。
    public static class NET_SDK_LOCAL_CFG_TYPE_CHECK_DEV extends Structure {
        public int dwCheckOnlineTimeout;            //巡检时间间隔
        public int dwCheckOnlineNetFailMax;            //由于网络原因失败的最大累加次数
